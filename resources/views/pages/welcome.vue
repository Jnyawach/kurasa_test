<template>
    <main-layout>
        <div>
            <div class="rounded-xl my-5 bg-gray-100 py-3 px-3 flex items-center gap-2">
            ...
            <div class="bg-white shadow rounded-xl">
                <div class="flex justify-between p-3 py-5">
                    <div>
                        <h2 class="text-lg font-bold">Supermarkets</h2>
                    </div>
                    <div class="flex gap-1">
                        ...
                        <div>
                            <button @click="newSupermarket=true" class="font-bold bg-sky-600 text-white py-2 px-5 rounded-lg flex items-center gap-1">
                                ...
                                <span>New supermarket</span>
                            </button>
                        </div>
                    </div>
                </div>
                <div class="divide-y" v-if="grid===1">
                    <div class=" p-2 py-5" v-for="supermarket in supermarkets.data" :key="supermarket.id">
                        <div class="flex gap-5 justify-between">
                            <div>
                                <p class="font-bold text-lg">{{supermarket.name}}</p>
                                <p><span class="text-sky-700 mr-2 font-medium">Location:</span>{{supermarket.town}}, {{supermarket.country}}</p>
                                <div>
                                    <p><span class="text-sky-700 mr-2 font-medium">Suppliers:</span>{{supermarket.suppliers_count}}</p>
                                    <p><span class="text-sky-700 mr-2 font-medium">Managers:</span>{{supermarket.managers_count}}</p>
                                </div>
                            </div>
                            <div class="flex gap-2 items-center">
                                <div>
                                    <Link :href="'supermarket/'+supermarket.id" class="text-sky-600 m-2 font-medium hover:text-sky-700">
                                        Details
                                    </Link>
                                </div>
                                <div>
                                    <edit-supermarket :supermarket="supermarket">
                                        <template #trigger>
                                ...
                                <div>
                                    <Link method="DELETE" as="button" :href="'/supermarket/'+supermarket.id" class="text-red-600 m-2 font-medium hover:text-red-700">
                                        Delete
                                    </Link>
                                </div>
                ...
                <div class="grid grid-cols-3 p-3 gap-3" v-if="grid===2">
                    <div class="shadow border rounded-lg p-3" v-for="supermarket in supermarkets.data" :key="supermarket.id">
                      <div class="flex items-center justify-between">
                          <h2 class="font-bold text-lg">{{supermarket.name}}</h2>

                      </div>
                        <p><span class="text-sky-700 mr-2 font-medium">Location:</span>{{supermarket.town}}, {{supermarket.country}}</p>
                        <div>
                            <p><span class="text-sky-700 mr-2 font-medium">Suppliers:</span>{{supermarket.suppliers_count}}

                            </p>
                            <p><span class="text-sky-700 mr-2 font-medium">Managers:</span>{{supermarket.managers_count}}
...
import EditSupermarket from "@/views/components/edit-supermarket.vue";
