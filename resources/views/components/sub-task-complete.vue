<template>
    <button @click="show=true" class="text-sky-600">Mark as complete</button>
    <teleport to="body">
        <Transition
        ...
        >
            <div v-if="show" class="inset-0 fixed bg-black bg-opacity-70 z-[100000] grid place-items-center p-5" >
                <div class="bg-white lg:w-4/6 w-full rounded-xl">
                        ...
                        <div class="flex justify-between">
                            ...
                            <slot name="header">
                                <div class="font-bold text-sky-600 text-lg">
                                    <h6>Mark Sub-task as complete</h6>
                                </div>
                            </slot>
                            <div>
                                <div class="text-end">
                    ...
                    <div class="p-5 ">
                       <form @submit.prevent="submit">
                           <div class="grid my-3">
                               <label class="creative-label" for="task_description">Add remarks:</label>
                               <textarea class="creative-text-input" id="task_description" rows="5" v-model="form.remarks"></textarea>
                               <div v-if="form.errors.remarks" class="creative-error">
...
const submit=()=>{
    form.patch('/sub_tasks/complete/'+props.sub_task.id,{
        onSuccess:()=>{
            form.reset()
